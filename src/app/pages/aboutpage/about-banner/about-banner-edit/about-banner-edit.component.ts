...
@Component({
	selector: 'app-about-banner-edit',
	templateUrl: './about-banner-edit.component.html',
	styleUrls: ['./about-banner-edit.component.scss']
})
export class AboutBannerEditComponent implements OnInit {
			...
			this.bannerService.addBanner(obj).subscribe(
				(response) => {
					if (response.code == 200) {
						...
						setTimeout(() => {
							this.router.navigate(['/aboutpage/banner-view']);
						}, 2000);
					}
					else {
						this.throw_msg = response.message
